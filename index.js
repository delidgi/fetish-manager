...
const FETISHES = {
    ...
    lactation: { name: "Лактация", icon: "🍼", cat: "phys", prompt: `[FETISH: Lactation] {{char}} has a lactation fetish and focuses on breast milk and nursing.` },
    pregnancy: { name: "Беременность", icon: "🤰", cat: "phys", prompt: `[FETISH: Pregnancy] {{char}} has a pregnancy fetish and focuses on the state of being pregnant and gravidity.` },
